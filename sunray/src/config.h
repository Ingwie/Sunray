...
#define GY85
#define IMU_LOOP_TIME 30 // FUSIONPERIOD Must be sync
//#define MPU6050
//#define MPU9150
...
// ------ MQTT (for Alfred only, highly experimental - ENABLE_SERVER must be set to false for this to work :-/ ) -----------------------------
...
#define BUMPER_DEADTIME 10 		// linear motion dead-time (ms) after bumper is allowed to trigger
...
#define GO_HOME_VOLTAGE   25.9  // start going to dock below this voltage
// The battery will charge if both battery voltage is below that value and charging current is above that value.
#define BAT_FULL_VOLTAGE  29.2  // start mowing again at this voltage
#define BAT_FULL_CURRENT  0.0   // start mowing again below this charging current (amps)
