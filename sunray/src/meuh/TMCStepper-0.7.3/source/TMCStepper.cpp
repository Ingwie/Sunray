...
{
  return read(GSTAT_t::address);
}
void  TMCStepper::GSTAT(uint8_t)
{
  write(GSTAT_t::address, 0b111);
}
...
{
  return read(TSTEP_t::address);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: TPWMTHRS
uint32_t TMCStepper::TPWMTHRS()
{
  return TPWMTHRS_register.sr;
}
...
{
  return read(MSCURACT_t::address);
}
