...
uint32_t TMC2660Stepper::DRVSTATUS()
{
  ...
  switch(rdsel())
    {
    case 0b00:
      READ_RDSEL00_register.sr |= response & 0xFFC00;
      break;
    case 0b01:
      READ_RDSEL01_register.sr |= response & 0xFFC00;
      break;
    case 0b10:
      READ_RDSEL10_register.sr |= response & 0xFFC00;
      break;
    default:
      return 0;
    }
...
{
  if(rdsel() != 0b00) rdsel(0b00);
  GET_REG00(mstep);
}
uint8_t TMC2660Stepper::se()
{
  if(rdsel() != 0b10) rdsel(0b10);
  GET_REG10(se);
}
...
uint16_t TMC2660Stepper::sg_result()
{
  ...
  switch(rdsel())
    {
    case 0b01:
      out = READ_RDSEL01_register.sg_result;
      break;
    case 0b10:
      out = READ_RDSEL10_register.sg_result;
      break;
    default:
      break;
    }
