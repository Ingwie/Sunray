...
static int16_t _i2c_error(i2c_t *i2c, int16_t code, int16_t c_errno, const char *fmt, ...)
{
  va_list ap;
...
int16_t i2c_open(i2c_t *i2c, const char *path)
{
...
int16_t i2c_transfer(i2c_t *i2c, struct i2c_msg *msgs, size_t count)
{
...
int16_t i2c_tostring(i2c_t *i2c, char *str, size_t len)
{
...
int16_t i2c_errno(i2c_t *i2c)
{
  return i2c->error.c_errno;
}

int16_t i2c_fd(i2c_t *i2c)
{
  return i2c->fd;
}
