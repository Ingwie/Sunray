...
ERingBuffer::ERingBuffer(uint16_t size)
{
  _size = size;
...
void ERingBuffer::getStr(char * destination, uint16_t skipChars)
{
  int16_t len = ringBufP-ringBuf-skipChars;
...
void ERingBuffer::getStrN(char * destination, uint16_t skipChars, uint16_t num)
{
  int16_t len = ringBufP-ringBuf-skipChars;
