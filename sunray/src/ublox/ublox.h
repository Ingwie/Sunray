...
private:
  ...
  bool debug;
  bool verbose;
  uint32_t solutionTimeout;

  void begin();
  void addchk(int16_t b);
  void dispatchMessage();
  int32_t unpack_int32(int16_t offset);
  int16_t unpack_int16(int16_t offset);
  int8_t unpack_int8(int16_t offset);
  int32_t unpack(int16_t offset, int16_t size);
  void parse(int16_t b);
};
