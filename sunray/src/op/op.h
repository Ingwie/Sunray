...
{
public:
  uint32_t nextImuCalibrationSecond;
  int16_t imuCalibrationSeconds;
  virtual String name() override;
...
public:
  ...
  int16_t mapRoutingFailedCounter;
  MowOp();
  virtual String name() override;
  virtual void begin() override;
  virtual void end() override;
...
public:
  ...
  uint32_t dockReasonRainAutoStartTime;
  bool lastMapRoutingFailed;
  int16_t mapRoutingFailedCounter;
  DockOp();
  virtual String name() override;
...
{
public:
  uint32_t retryTouchDockSpeedTime;
  uint32_t retryTouchDockStopTime;
  uint32_t betterTouchDockStopTime;
  bool retryTouchDock;
  bool betterTouchDock;
  uint32_t nextConsoleDetailsTime;
  virtual String name() override;
  virtual void begin() override;
  virtual void end() override;
  virtual void run() override;
...
{
public:
  uint32_t recoverGpsTime;
  int16_t recoverGpsCounter;
  virtual String name() override;
  virtual void begin() override;
  virtual void end() override;
  virtual void run() override;
